...
VkResult BrnSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult BrnSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                            uint32_t *imageIndex) {
...
void BrnSwapChain::createSwapChain() {
...
void BrnSwapChain::createImageViews() {
...
void BrnSwapChain::createRenderPass() {
...
void BrnSwapChain::createFramebuffers() {
...
void BrnSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR BrnSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR BrnSwapChain::chooseSwapPresentMode(
...
VkExtent2D
BrnSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat BrnSwapChain::findDepthFormat() {
