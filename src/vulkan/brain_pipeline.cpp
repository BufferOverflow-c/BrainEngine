...
void BrnPipeline::createGraphicsPipeline(const std::string &vertFilePath,
                                         const std::string &fragFilePath,
                                         const PipelineConfigInfo &configInfo) {
  ...
  if (vkCreateGraphicsPipelines(brnDevice.device(), VK_NULL_HANDLE, 1,
...
void BrnPipeline::createShaderModule(const std::vector<char> &code,
  ...
  if (vkCreateShaderModule(brnDevice.device(), &createInfo, nullptr,
...
void BrnPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo) {
...
void BrnPipeline::enableAlphaBlending(PipelineConfigInfo &configInfo) {
