...
namespace brn {
    ...
    BrnModel::BrnModel(BrnDevice &device, const std::vector<Vertex> &verticies) : brnDevice(device) {
    ...
    std::vector<VkVertexInputBindingDescription> BrnModel::Vertex::getBindingDescriptions() {
    ...
    std::vector<VkVertexInputAttributeDescription> BrnModel::Vertex::getAttributeDescriptions() {
